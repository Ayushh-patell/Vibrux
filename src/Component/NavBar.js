...
{/*         LUANCH APP BUTTON FOR MOBILE         */}
        ...
        <div className=' w-full grid grid-cols-2 gap-2 font-chakra my-10 lg:p-0 p-5'>
            ...
            <div className=' w-full overflow-x-hidden text-left'>
                <div className=' flex justify-start items-center gap-2 relative -left-[23px] mb-2 navFooterItem transition-[left] duration-200 ease-out'><img src="../Arrow.svg" alt="arrow" className=' h-3 inline-block' /> <a href="http://docs.vibrux.finance" target="_blank" rel="noopener noreferrer">Docs</a></div>
            </div>
            </div>
            <div> 
